...
wt1 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt2 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt3 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt4 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt5 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt6 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt7 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt8 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt9 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
wt10 <- walktrap.community(y, weights = NULL, membership=T, modularity=T)#, update.rule="config",start.temp=1, stop.temp=.80, gamma =2)
sizes(wt1)
membership(wt1)
communities(wt1)
...
cc <-get.edgelist(comGraphBig1)
cc
write.csv(cc, "results/wt/wt1_comm1.csv")
